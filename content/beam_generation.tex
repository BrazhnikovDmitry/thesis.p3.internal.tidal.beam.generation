...
So now we are in position to investigate effects of the inhomogeneous generation on the tidal beam. 
...
shows comparison of the mean energy flux direction and integrated flux in case of each realization. 
...
Nevertheless, there are apparent differences between the analytical model and the numerical results 
...
frequency as manifestation of nonlinear terms. These processes are the most important. And 
...
approaches are used to diagnose the spectrum. This is carried out by computing two spectral moments,
\begin{align}
...
motions \citep{zaron2014time}. Respectively, 
\begin{align}
\frac{\delta c_p}{c_p} \approxeq \frac{\delta c_0}{c_0} + \frac{|\bar{u}|}{c_p} + \frac{1}{2} 
\frac{f^2}{\omega^2} Ro
\end{align}
The background currents are vertically averaged, so that effect of shear is not accounted for.\\
...
with the rest producing a horizontal reorientation of the fluxes. Similar phenomena was observed in 
...
The further development are shown on Fig. where the fields are given for mid-February, 10th - 15th. 
...
Here it is presented two cases that shows how complex such interactions can be (Fig.). In the first 
