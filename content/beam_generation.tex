...
with diametrically different generation regimes ('2014' and 'd10-15', \fignml[C3.fig:gen]{c}).\\
...
water column other processes take place. For case of '2014' simulation \fignmlp[C3.fig:gen_2d]{a, 
b} 
...
vertical 
component of the barotropic flow has the opposite direction. For \sqm{d10-15} propagating mode-1 is 
...
internal wave in Solander Trough \fignmlp[C3.fig:gen_2d]{a, b}. The reflection coincides with the 
...
side \fignmlp[C3.fig:gen_2d]{f}. These points are further explored on \fignmlp[C3.fig:gen_2d]{g} 
