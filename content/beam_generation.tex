...
the decomposition analysis \fignmp{C3.fig:wv_fld_dist}. The westward wave in \sqm{2014} is small as 
generation at the Campbell Plateau is diminished (see also 
\fignml[C3.fig:gen]{C}). And since lines of constant phase (isochrons) are slanted relative to the 
ridge, such 
...
overall 
production at the Macquarie Ridge increased from ... to ... \fignmlp[C3.fig:gen]{D} as the westward 
...
generation/destruction. For \sqm{2014} there is a strong destruction evident near $(166.5E, 
48.75S)$, \fignmlp[C3.fig:wv_fld_dist]{A}, and the other cases show insignificant energy loss. This 
location corresponds to impingement of the eastward-traveling wave produced at the northern 
seamount \fignmlp[C3.fig:wv_fld_dist]{bottom row}. And as before its phase lag to barotropic tide 
is a primary factor. That is, earlier arrival such as in \sqm{d10-15} and \sqm{d35-40} corresponds 
to weak energy losses and can also explain higher production rates at the Campbell Plateau in the 
later case \fignmlp[C3.fig:gen]{C}.\\

It is straightforward to establish a relation between the phase of the eastward waves and mode-1 
eigenspeed under extreme conditions. For example, generation in \sqm{2014}-experiment is  
exacerbated by negative anomaly in the phase speed of $15\%$, i.e. $\sim 20^{\circ}$ or $40$ minute 
later arrival. Opposite situation is seen for \sqm{uniform}-experiment where higher phase speed 
leads to much earlier arrival and very strong amplification (compare \fignml[C3.fig:gen]{B} with 
\fignml[C3.fig:wv_fld_dist]{A-C}). But in the 
cases of modest departure, such interpretation is complicated with initial phase of the 
eastward waves. The field emitted by the northern seamount is about at $0^{\circ}$ in \sqm{d10-15}, 
while in \sqm{d35-40} - $\sim 50^{\circ}$. In turn, the difference 
...
positive speed anomaly. It is notable that in \sqm{2014} (red line) a mixture of SAW and STW led to 
...
\fignmlp[C3.fig:wv_fld_dist]{D}. A weak vertical density gradient was present again and 
...
\fignml[C3.fig:gen_dynamics]{A, B}. It is seen that variability of generation at the gap explains  
...
quantified as integral of energy flux across a red line on \fignmlp[C3.fig:wv_fld_dist]{F} and 
given by black line on \fignml[C3.fig:gen_dynamics]{B}. Correlation coefficient between the 
generation and the flux is $R^2 = 50\%$, but after omitting \sqm{uniform}-experiment, $R^2$ rises 
to $80\%$. The \sqm{uniform} experiment is an outlier because the uniformly prescribed 
...
lee side of the ridge and partly out-phase on the western side \fignmlp[C3.fig:gen]{B}. This regime 
is clearly opposite to other experiments \fignmlp[C3.fig:gen]{C}.\\
...
converse dependence \fignmlp[C3.fig:gen_dynamics]{C}. The inconsistency was resolved by 
...
\fignmlp[C3.fig:gen_dynamics]{A, empty diamonds} and then they were used to scale the overall 
incident flux (integrated across blue line on \fignml[C3.fig:stand_wave]{C}). 
\fignml[C3.fig:gen_dynamics]{C} suggests the change in stratification affects ridge's transmission 
...
\fignmlp[C3.fig:gen_dynamics]{B}, but this contradicts largely subcritical slope and only small  
change in the crossing mode-1 \fignmlp[C3.fig:gen_2d]{C-D}. Using the decomposition method 
different values were obtained and given by filled dots on \fignmlp[C3.fig:gen_dynamics]{A-B}. The 
...
as the knife-edge calculations, i.e. to produce \fignmlp[C3.fig:gen_dynamics]{D}, no correlation 
...
edge \fignmlp[C3.fig:gen_dynamics]{C} in $1~GW$ with the ROMS-derived - $1.7~GW$, the same 
...
\citep{buijsman2014three}. Here the results on \fignml[C3.fig:stand_wave]{D} indicate more 
...
distribution of conversion and its variation \fignmlp[C3.fig:gen]{C}. This is quantified by 
differentiating 
...
conversion is caused by particular parameter \fignmp{C3.fig:var_sp}. It is found that total 
variation 
...
\begin{figure}
	\centering
	\includegraphics[scale = 
	1]{/home/dmitry/Work/Research/thesis/FINALE/P3_ITS_GENERATION/figures/fig_9_ener_relations.png}
	\caption{}
...
\begin{figure}
	\centering
	\includegraphics[scale = 
	1]{/home/dmitry/Work/Research/thesis/FINALE/P3_ITS_GENERATION/figures/fig_10_var_gen.png}
	\caption{}
	\label{C3.fig:var_sp}
\end{figure}
%\begin{figure}
