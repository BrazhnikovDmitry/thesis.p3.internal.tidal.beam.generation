...
energy transfer can take. \fignm{C3.fig:gen_2d} depicts wave evolution on panels A-D throughout ebb 
...
reflectance 
\fignmp{C3.fig:crit}. It follows that the remote energy was mainly transmitted through the 
subcritical gap, 
...
\citep{kerry2014impact}. Results are provided on \fignm{C3.fig:var_sp}. Notably, the total 
...
eastward waves corroborating \fignm{C3.fig:wv_fld_dist}.\\

\fignm{C3.fig:crit} also demonstrates variation in the reflectivity of the eastern slope between 
the 
experiments. 
It seems that migration of hot spot in the conversion and spatial variability observed on  
\fignm{C3.fig:gen}, can be explained 
by changes in the criticality and transmission of the westward waves. For example, spatial 
distribution of the conversion moved northward for the northern seamount between \sqm{d10-15} and 
\sqm{d35-40} \fignmlp[C3.fig:gen]{D} as criticality decreased in that portion of the ridge 
\fignmp{C3.fig:crit}. This suggests another effect of stratification on the double-ridge system 
which is addressed in Section \ref{C3.sec:strat_eff}.\\

Temporal evolution of the conversion magnitude is addressed by \fignm{C3.fig:ener_var} 
...
was substantially higher and rose to $0.8$ if \sqm{uniform} was omitted.\\

Experiment \sqm{uniform} is another outlier as it presented dynamically opposite regime to other 
extreme of \sqm{2014}. The prescribed uniform 
stratification 
...
Purple insets on \fignm{C3.fig:ener_var} present transmission coefficients obtained from the 
...
diamonds on \fignm{C3.fig:ener_var}.\\
...
experiments on \fignml[C3.fig:regr]{A}. Contrary to the expectation of larger conversion by 
...
trough. \fignml[C3.fig:regr]{B} shows 
relation between the westward wave magnitude scaled by the previously found transmission 
coefficients (i.e. from \fignml[C3.fig:ener_var]{A} black dots were scaled by empty diamonds). 
...
the 
results on \fignml[C3.fig:stand_wave]{D} indicated more consistency of the eastward component in 
the 
...
\fignmp{C3.fig:wv_fld_dist} lead to spatial variability of the enhancement.\\
