...
\section*{Abstract}
\textbf{NEW VERSION:}\\
Pelagic dissipation of the barotropic tides takes place at strong topographic gradients through 
generation of the internal tidal waves. This study addresses variability of the energy conversion 
for $M_2$ constituent at the Macquarie Ridge in the Tasman Sea. The considered region is decribed 
as a semi-enclosed basin that conducive to complex internal tidal regime. Its response to variable 
ocean state is investigated by a primitive equation model initialized with different hydrographic 
conditions. The main goal of the simulations is to compliment a field program, Tasman TIdal 
Dissipation 
Experiment (TTIDE), addressed to study fate of the radiated internal tide. The numerical 
experiments yielded 
the mode-1 production to alter by $\pm 10\%$. It was impelled by passage of 
remotely-emitted internal tides and their interference with the generation at the ridge. A novel 
decomposition technique emphasized three-dimensionality of the remote wave field and importance of 
multiple reflection on the wave strength. The temporal alterations were induced by the variable  
water mass distribution or position of the local front by controlling wave speed and the basin 
slopes reflectivity. The described processes bring about variability in the generation and the 
internal tide intensity that can cause intermittency in far field, many mode-1 wavelengths away and 
can affect field observations such as TTIDE. And the provided results suggest a role of the tidal 
dissipation on the dynamics of the frontal zone.\\
