...
\fignmlp[C3.fig:stand_wave]{D} as follows. First, by swapping $C$ and $M$ in \eqref{C3.eq:fl_fabry} 
...
westward flux \fignmlp[C3.fig:stand_wave]{D}. This implies less variation of the ridge reflection 
