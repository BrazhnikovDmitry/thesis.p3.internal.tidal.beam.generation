...
if the downward current, say, coincides with lifting of the isopycnals. As 
consequence, 
the baroclinic field loses energy by acting against the forcing. Such dynamical situation 
might arise when non-locally generated internal tidal waves are present. But when the remote waves 
are in-phase, an amplified energy transfer from the surface tide occurs. Note the interaction 
...
Fig. highlights such differences in the energy conversion for two experiments. At first, between 
them 
there was similarity in that during ebb 
flow \fignmlp[C3.fig:gen_2d]{A, B, location shown by vertical solid line} the downward barotropic 
current depressed the isopycnals, and conversion was positive as it is shown by 
\fignml[C3.fig:gen_2d]{E}. However, about hour 7 in \sqm{2014} the transfer reversed direction as 
an upward motion began to develop which was fully observed at slack tide \fignml[C3.fig:gen_2d]{C}. 
This baroclinic motion seemed to be attributed to an internal wave emitted from the ridge crest 
earlier. The ray destructively interfered with the local generation to result in energy loss. 
Nevertheless, the period-averaged conversion was positive, but weak.\\

Simulation during \sqm{d10-15} presented remarkably different structure of the field. It was 
characterized 
with shoaling mode-1 wave manifested as vertical dipole within the baroclinic pressure. The 
propagation was accompanied by downward isopycnal motions forced along the slopes of the ridge. 
On the tideward side the process was in-phase with the forcing leading to amplification, and, 
oppositely, the eastward side demonstrated the baroclinic energy loss. To conclude, the period 
averaged conversion  for the same section are given by Fig. The tideward side in \sqm{2015} 
exhibited twenty-fold stronger generation, but reverse energy transfer on the leeward side. In 
contrast, during \sqm{2014} the waves were mainly radiated by the eastward side.\\

The remote mode-1 was observed in the Solanders trough in both experiments. And the differences in 
the 
generation dynamics appeared due to the remote wave travel path and not phase. This conclusion is 
further augmented by the directional decomposition (Fig.). The trough was occupied 
by the standing wave seen by almost constant phase (i.e. no propagation) in the total signal. Near 
the Campbell plateau it was decomposed into the east and west components almost equally. However, 
by 
the ridge in \sqm{2015} the total wave was seen to propagate across the ridge with the westward 
component to be dominant. And in \sqm{2014} the eastward wave was stronger and the phase 
of the total signal tended to $-180^{\circ}$, hence, the wave field was mainly due to the local 
generation. At the same time, the arrival of the remote wave was not different between the two 
cases. \\
