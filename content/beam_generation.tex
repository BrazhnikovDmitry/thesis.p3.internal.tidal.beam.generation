...
Experiment (TTIDE), addressed to study the fate of the radiated internal tides. The ridge and the 
nearby Campbell Plateau forms a semi-enclosed basin that is conducive to strong interference and 
complex internal-tide behavior. Primary dynamical feature is coupling of shoaling remote 
waves with local wave generation to amplify or reduce the conversion. So that  
change in the energy transfers to mode-1 by $\pm 10\%$ and in the spatial distribution is 
strongly associated with characteristic of the remote, plateau-emitted waves. A novel technique for 
decomposing the 
superposition is utilized to examine the wave-field variability. The result emphasizes 
three-dimensionality of the plateau-emitted waves and the importance of multiple reflections on the 
wave amplitudes. It is shown that temporal alterations are induced by the variable water mass 
distribution or 
...
the amplification. Variable strength of the conversion implies basin-scale change of the wave field 
