...
b, c}. Such that the tideward and leeward wave fields are shifted one to another. Thence, the 
...
slanted near ridge \fignmlp[C3.fig:anlt_sol]{Panel c}. Both effects are highly dependent on number 
...
\fignmp{C3.fig:beam_prms} and was also diagnosed by the angular decomposition as Southwestern 
waves \fignmp{C3.fig:beam_dcmp}. This phenomena was originally identified by 
...
\fignmp{C3.fig:BT} at the Macquarie Ridge.\\
...
solution is taken to extreme of the critical latitude \fignmlp[C3.fig:anlt_sol]{Panel d}. In this 
...
refraction. On \fignm{C3.fig:KE_beam} this is depicted by diamonds representing the beam southward 
...
period simulation \fignmlp[C3.fig:KE_beam]{inset} it is seen a growth of kinetic energy caused by 
...
(green arrows). If the planar beam component \fignmp{C3.fig:beam_dcmp} is considered alone, then 
...
Now the point-wise decomposition is applied to the TBEAM observations \fignmp{C3.fig:dcmp_A1} 
...
respectively, \fignmlp[C3.fig:gen_var_beam]{d} shows how the actual parameter varies and their 
...
line}. For instance, two extreme values at the start and the end of the field-period simulation  
correspond to cases of focused beam when refraction caused beam's self-interference (e.g.)
\fignmp{C3.fig:meso_examp}. In the first case, position and overall weak magnitude led to smaller 
...
\fignmlp[C3.fig:dcmp_A1]{Panels a, c}. So that using the previous inferences it is speculated that 
...
energy flux turned southward \fignmlp[C3.fig:dcmp_A1]{Panel c, dots} and later rebounded back by 
$10^\circ$ northward.\\
