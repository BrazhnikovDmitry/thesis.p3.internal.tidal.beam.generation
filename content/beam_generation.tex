...
In conclusion, on \fignm{C3.fig:ener_var} time series of the conversion are plotted along 
...
\fignml[C3.fig:ener_var]{A}. Though the primary factor was the amplitude of the 
westward waves. Nevertheless, among the numerical simulations there are number of experiments that 
does not support these arguments. For example, in experiments \sqm{d25-30} and \sqm{d40-45} 
