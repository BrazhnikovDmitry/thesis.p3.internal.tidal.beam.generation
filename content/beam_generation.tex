...
\section*{Abstract}
\textbf{NEW VERSION:}\\
Variability in conversion of the barotropic tidal energy into internal tidal waves at the Macquarie 
Ridge is addressed by carrying out numerical experiments with variable hydrographic conditions. The 
main goal of the simulations is to compliment a field program, Tasman TIdal Dissipation Experiment 
(TTIDE), addressed to study the fate of the radiated internal tides. The ridge and the nearby 
Campbell 
Plateau forms a semi-enclosed basin that is conducive to strong interference and complex 
internal-tide regime. Primary feature of which is coupling of shoaling remote waves with local 
generation processes to amplify or reduce the conversion. It is shown that the ridge mode-1 
production 
change in $\pm 10\%$ and 
its spatial 
distribution is strongly associated with characteristic of the remote, plateau-emitted waves. To 
examine the wave-fields variability, a novel technique for decomposing the superposition is  
utilized. The result emphasizes three-dimensionality of the plateau-emitted waves and the 
importance 
of multiple reflection on the wave amplitudes. Temporal alterations are induced by the variable  
water mass distribution or position of the local front by controlling wave speed. Additionally, 
local stratification modulates the ridge slopes reflectivity/transmission and hence, magnitude of 
the amplification. 
The described processes bring about variability in the generation and the internal tide intensity 
that can cause intermittency in far field, many mode-1 wavelengths away and can affect field 
observations such as TTIDE. The results also suggest an important role of the tidal dissipation on 
the dynamics of the frontal zone.\\
